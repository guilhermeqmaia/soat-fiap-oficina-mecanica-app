...
VALUES
  ...
  (gen_random_uuid(), 'Atendente Teste',  'atendente@oficina.com',  '11144477735', '$2b$10$P1e.iAkebh/yETasKCnkBuQXTqg9zyhWoHPLU6igEU0YP68yrxSFC', 'ATENDENTE',  true, NOW(), NOW()),
  ...
  (gen_random_uuid(), 'Cliente Teste',    'cliente@oficina.com',    '39053344705', '$2b$10$jQLovE7nj4y0f6N16DEAA.et/w10PiPjimxKboCwv3YtkBJ7FIciS', 'CLIENTE',    true, NOW(), NOW())
